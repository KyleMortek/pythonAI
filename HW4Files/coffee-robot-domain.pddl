...
(:action close
	:parameters (?d - door ?r1 ?r2 - room ?rob - robot)
	:precondition (and (isOpen ?d) (connects ?d ?r1 ?r2) (at ?rob ?r1) (emptyHand ?rob));(and (isOpen ?d) (connects ?d ?r1 ?r2) (at ?rob ?r1) (emptyHand ?rob))
	:effect (and (isClosed ?d) (not (isOpen ?d))(not(adj ?r1 ?r2)) (not(adj ?r2 ?r1)))
)
(:action move
	:parameters (?r1 ?r2 - room ?rob - robot); ?d - door)
	:precondition (and (adj ?r1 ?r2)(adj ?r2 ?r1)(at ?rob ?r1));(and (isOpen ?d) (at ?rob ?r1)(adj ?r1 ?r2)(adj ?r2 ?r1));(and (isOpen ?d) (at ?rob ?r1) (connects ?d ?r1 ?r2) (adj ?r1 ?r2)(adj ?r2 ?r1))
